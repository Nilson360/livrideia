...
class ResetPasswordController extends AbstractController
{
    ...
    public function request(Request $request, MailerInterface $mailer, TranslatorInterface $translator): Response
    {
        ...
        if ($this->deviceDetector->isMobile()) {
            return $this->render('auth/mobile/reset_password/request.html.twig', [
                'requestForm' => $form,
            ]);
        }
    ...
    public function reset(Request $request, UserPasswordHasherInterface $passwordHasher, TranslatorInterface $translator, ?string $token = null): Response
    {
        ...
        if ($this->deviceDetector->isMobile()) {
            return $this->render('auth/mobile/reset_password/reset.html.twig', [
                'resetForm' => $form,
            ]);
        }

        // Version desktop par défaut
        return $this->render('auth/desktop/reset_password/reset.html.twig', [
            'resetForm' => $form,
        ]);
    }
